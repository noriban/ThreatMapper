...
func fromDefault(n Node, key string) (interface{}, bool) {
	for _, from := range []func(n Node, key string) (interface{}, bool){fromLatest, fromSets, fromCounters} {
...
func fromLatest(n Node, key string) (interface{}, bool) {
	return n.Latest.Lookup(key)
}

func fromSets(n Node, key string) (interface{}, bool) {
	val, ok := n.Sets.Lookup(key)
	return strings.Join(val, ", "), ok
}

func fromCounters(n Node, key string) (interface{}, bool) {
