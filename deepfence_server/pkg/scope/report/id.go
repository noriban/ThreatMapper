...
var (
	...
	// MakeCloudProviderNodeID produces a cloud provider node ID from its composite parts.
	MakeCloudProviderNodeID = makeSingleComponentID("cloud_provider")

	// ParseCloudProviderNodeID parses a cloud provider node ID
	ParseCloudProviderNodeID = parseSingleComponentID("cloud_provider")

	// MakeCloudRegionNodeID produces a cloud region node ID from its composite parts.
	MakeCloudRegionNodeID = makeSingleComponentID("cloud_region")

	// ParseCloudRegionNodeID parses a cloud region node ID
	ParseCloudRegionNodeID = parseSingleComponentID("cloud_region")

	// MakeKubernetesClusterNodeID produces a kubernetes cluster node ID from its composite parts.
	MakeKubernetesClusterNodeID = makeSingleComponentID("kubernetes_cluster")

	// ParseKubernetesClusterNodeID parses a kubernetes cluster set node ID
	ParseKubernetesClusterNodeID = parseSingleComponentID("kubernetes_cluster")
...
func ExtractHostID(m Node) string {
	...
	hostID, _ := ParseHostNodeID(hostNodeID.(string))
	return hostID
}
