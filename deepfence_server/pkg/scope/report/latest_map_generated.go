...
func (m StringLatestMap) Lookup(Key string) (interface{}, bool) {
...
func (m StringLatestMap) LookupEntry(Key string) (interface{}, time.Time, bool) {
...
func (m StringLatestMap) ForEach(fn func(k string, timestamp time.Time, v interface{})) {
	for _, value := range m {
