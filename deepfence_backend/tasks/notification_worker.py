...
from models.notification import VulnerabilityNotification, CloudtrailAlertNotification, ComplianceReportNotification
...
from utils.constants import NOTIFICATION_TYPE_VULNERABILITY, NODE_TYPE_HOST, NODE_TYPE_CONTAINER, \
    NODE_TYPE_CONTAINER_IMAGE, NODE_TYPE_POD, CVE_ES_TYPE, CLOUDTRAIL_ALERT_ES_TYPE, COMPLIANCE_ES_TYPE, \
