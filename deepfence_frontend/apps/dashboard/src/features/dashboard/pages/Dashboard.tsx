...
export const Dashboard = () => {
  ...
  return (
    <>
      <div className="grid grid-cols-[3fr_1fr] mt-2 gap-2">
        ...
        <Card className="flex flex-col px-8 justify-center gap-1">
          <Select
            value={value}
            name="fruit"
            onChange={(value) => {
      ...
      <div className="grid grid-cols-[35%_1fr_35%] gap-2 auto-rows-[minmax(300px,_auto)] mt-2">
        <AttackPath />
        <Registries />
        <TopRisks />
        <Activity />
